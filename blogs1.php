                    ...
                    <div class="row blog_margin"> 
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                            ...
                            <?php
                                ...
                                $i=0;
                                $obj=new database();
                                $res=$obj->bloguserjoin($sub_id, $start_from , $num_rec_per_page);
                              
                                $date=date("d-M");
                                $year=date("Y");

                                
                                while($row=mysql_fetch_assoc($res['data']))
                                {
                                    $blog_id=$row["blog_id"];
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    echo "<a href='blogs.php?page=1'>".'|<'."</a> "; // Goto 1st page  
$total_pages = $res['count'];
for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='blogs.php?page=".$i."'>".$i."</a> "; 
}; 
echo "<a href='blogs.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
