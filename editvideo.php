...
<head>
    ...
    <body>
        ...
        while($row=mysql_fetch_assoc($res))
        {
                    ...
                    //$notes=$row["notes"];
                    $notes='https://www.youtube.com/watch?v='.$row["notes"].'';
                    $type=$row["type"];
     ...
     ?>
       ...
       <!--  edit blog  -->
           ...
           // echo $notes_img;
            ...
            $obj1=new database();
            $res1=$obj1->myvideoupdate($notes_id,$notes_title,$notes,$notes);

            echo '<script langauge="javascript">;
                alert("videos updated sucessfully");
                ...
                <div class="container">
                  ...
                  <form action=""  enctype="multipart/form-data" method="post">
                           ...
                           <div class="leave-comments">
                                        <h3 class="sidebar-title">Edit Video</h3>
                                        <div class="row">
                                                    ...
                                                    <fieldset>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" name="videotitle" placeholder="Video Title" class="form-control" value="<?php echo $notes_title; ?>">
                                                         ...
                                                         <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" name="video" placeholder="Video" class="form-control" value="<?php echo $notes; ?>">
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group margin-bottom-none">
                                                                <button type="submit" name="editvideo" class="view-all-accent-btn">Update Video</button>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                </form>
