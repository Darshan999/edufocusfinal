        ...
        <div id="wrapper">
                         ...
                         <div class="row search-inner searchbar_color">
                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                <div class="search-input searchbar_inputtext">
                                        ...
                                        <input type="text" value="<?php if(isset($_POST['txttitle']) && $_POST['txttitle'] !== "") { echo $_POST['txttitle'];}?>" name="txttitle" class="search-form" placeholder="Blogs Keywords . . ." required="">  
            ...
            <div class="news-page-area">
                ...
                if(isset($_POST["btntitlesearch"]))
                {
                    ...
                    $obj=new database();
                    $res=$obj->searchbytitle1($searchtitle,$sub_id);
