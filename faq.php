                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                <div class="search-input searchbar_inputtext">
                                    <form action="" method="post">
                                        ...
                                        <input type="text" value="<?php if(isset($_POST['txttitle']) && $_POST['txttitle'] !== "") { echo $_POST['txttitle'];}?>" name="txttitle" class="search-form" placeholder="Questions Keywords . . ." required="">  
                    ...
                    <div class="row panel-group blog_margin" id="faq-accordian">
                     ...
                     if(isset($_POST["btntitlesearch"]))
                     {
                       ...
                       $i=0;
                        ...
                        $obj=new database();
                        $res=$obj->searchquebytitle1($searchtitle,$sub_id);
