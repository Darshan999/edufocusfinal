                                         ...
                                         <div aria-expanded="false" id="collapseOne'.$i.'" role="tabpanel" class="panel-collapse collapse">
                                            <div class="panel-body faq-box-body">
                                                <p>'.$row["ans_desc"].'</p>
                                                  ...
                                                  <a href="editans.php?ans_id='.$ans_id.'"><button type="submit" name="editans" class="view-all-accent-btn">Edit</button></a>
                                          
                                           
                                     <a href="ansaction.php?ans_id='.$ans_id.'" onClick="return del()"><button type="submit" name="deleteans" class="view-all-accent-btn">Delete</button></a>
