                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                <div class="search-input searchbar_inputtext">
                                    <form action="" method="post">
                                        ...
                                        <input type="text" value="<?php if(isset($_POST['txttitle']) && $_POST['txttitle'] !== "") { echo $_POST['txttitle'];}?>" name="txttitle" class="search-form" placeholder="Notes Keywords . . ." required="">  
                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="search-input searchbar_inputtext">
                                    <form method="post">
                                        ...
                                        <select id="ddl" name="select-user" class="form-control m-bot15 dropdown" onChange="window.location='searchnotes.php?u_email_id='+this.value">
                                  ...
                                  //       $sub_id=$_SESSION["sub_id"];
                                         ...
                                         {
                                            $selected='';
                                            if(isset($_GET['u_email_id']) && $_GET['u_email_id'] != "") { 
                                                $selected='selected';
                                                echo $selected;
                                            }
                            ...
                            <div class="row"> 
                                ...
                                <div class="tab-content">
                                    ...
                                    if(isset($_POST["btntitlesearch"]))
                                    {
                                        ...
                                        $obj=new database();
                                        $res=$obj->searchnotesbytitle1($searchtitle,$sub_id);
                                           ...
                                           // $ext = pathinfo($filename_from_url['path'], PATHINFO_EXTENSION);
                                            ...
                                            <div class="product-box1">
                                                <ul class="product-social">
                                                    ...
                                                    <li><a href='.$notes.' ><i class="fa fa-eye" aria-hidden="true" name="check"></i></a></li>
