    ...
    <body>
     ...
     <?php 
       ...
       <?php
              ...
              $pic=$u_photo;
                         ...
                         if($_FILES["photo"]["name"]=="")
                        {
                          ...
                          $photo=$u_photo;
                            ...
                            {
                                unlink($u_photo);
                                $photo="img/expert/".basename($_FILES["photo"]["name"]);
            ...
            $obj1=new database();
            $res1=$obj1->updateprofile($u_email_id,$u_name,$u_mobile_no,$photo,$u_qualification,$u_desc);
                                            ...
                                            <div class="contact-form"> 
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <fieldset>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" name="u_qualification" class="form-control" value="<?php echo $u_qualification; ?>">
                                                                <div class="help-block with-errors"></div>  
                                                            </div>
                                                        </div>
                                                         <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <textarea class="form-control ckeditor" name="u_desc" rows="6" placeholder="Blog Description" ><?php echo $u_desc; ?></textarea>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
