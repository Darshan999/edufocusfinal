                ...
                if(!empty($_SESSION["u_email_id"]))
                  {
                    ...
                    $que_title=strtolower($que_title);
                    $que_desc="";
                    $flag="inactive";
                    $que_date=date("Y/m/d");
                     $que_time=date("H:i:s");
                    ...
                    $viwe=1;
                 //  $fk_u_email_id=$_SESSION["u_email_id"];
                ...
                $target_file = $target_dir . basename($_FILES["photo"]["name"]);
                   move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file);
                    ...
                    if($cnt1==1)
                     {
                    $res=new database();
                    $cnt=$res->insertques($que_title,$que_desc,$que_date,$que_time,$target_file,$flag,$view,$u_email_id,$fk_sub_id);

                    header('location:faq.php?sub_id='.$fk_sub_id.'');
                ...
                <div class="container">
                  ...
                  <form action=""  enctype="multipart/form-data" method="post">
                           <div class="leave-comments">
                                        <h3 class="sidebar-title">Insert Question</h3>
                                        <div class="row">
                                                    ...
                                                    <fieldset>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" name="quetitle" placeholder="Question Title" class="form-control" required>
                                                       ...
                                                       <!-- <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group margin-bottom-none">
                                                                <button type="submit" name="quepost" class="view-all-accent-btn">Post Question</button>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                </form>
