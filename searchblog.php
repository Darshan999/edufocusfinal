                        ...
                        <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="search-input searchbar_inputtext">
                                    <form method="get">
                                        ...
                                        <select class="form-control m-bot15 dropdown search_dropdown22" onChange="window.location='searchblogbyuser.php?blog_title='+this.value">
                                        <option>Choose Blogs From Selected User</option>
                                  ...
                                  //       $sub_id=$_SESSION["sub_id"];
                                         ...
                                         $obj=new database();
                                         $res=$obj->searchuserblogs($sub_id,$u_email_id);
                                         ...
                                         while($row=mysql_fetch_assoc($res))
                                         {
                                            ...
                                            echo '<option>'.$row["blog_title"].'</option>';
                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                <div class="search-input searchbar_inputtext">
                                    <form method="get">
                                        ...
                                        <select class="form-control m-bot15 dropdown" onChange="window.location='searchblog.php?u_email_id='+this.value">
                                  ...
                                  //       $sub_id=$_SESSION["sub_id"];
                                         //include 'database.php';
                                         $obj=new database();
                                         $res=$obj->searchblogUser($sub_id);

                                         while($row=mysql_fetch_assoc($res))
                                         {

                                            $selected='';
                                            if(isset($_GET['u_email_id']) && $_GET['u_email_id'] == $row["u_email_id"]) { 
                                                $selected='selected';
                                            }
                    ...
                    <div class="row blog_margin"> 
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                            ...
                            <?php //search mate
                                ...
                                //echo $u_email_id;
                                $_SESSION['email']=$u_email_id;
                                $_SESSION['sub_id']=$sub_id;
                                $cnt=0;
                                $i=0;
                             $obj=new database();
                                //$res=$obj->bloguserjoin($sub_id,$u_email_id);
                                $res=$obj->searchbyuserblog($sub_id,$u_email_id);
                                ...
                                while($row=mysql_fetch_assoc($res))
                                {
                                    ...
                                    $res1=$obj->blogcommentcount($blog_id);
