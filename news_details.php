...
<head>
        ...
        <title>EduFocus | News Details</title>
                            ...
                            echo '
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="news-img-holder">
                                        <img src="'.$row["news_photo"].'" class="img-responsive blog_img" alt="research">
                                        <ul class="news-date1">
                                            <li>
                                                    '.$date.'
                                                </li>
                                    ...
                                    <h2 class="title-default-left-bold-lowhight"><a href="#">'.$row["news_title"].'</a></h2>
