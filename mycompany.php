                ...
                <div class="container">
                    <div class="row blog_margin"> 
                            ...
                            <?php
                                ...
                                //echo $u_email_id;
                                $obj1=new database();
                                $res1=$obj1->mycompanydisplay($u_email_id);
                              ...
                              echo ' <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                               <div class="media">
                                            <a href="#" class="pull-left">
                                                <img alt="Comments" src="'.$row["company_logo"].'" style=" height: 64px; width: 67px;" class="media-object">
                                            </a>
                                            <div class="media-body">
                                                <h3><a href="company_details.php?company_id='.$row["company_id"].'">'.$row["company_name"].'</a></h3>
                                                
                                                <p>'.$row["company_title"].'</p>


                                          <div class="col-lg-3 col-md-3 col-sm-8 col-xs-12" style="margin-top: 7px;">
                                  <a href="editcompanydetail.php?company_id='.$row["company_id"].'"><button type="submit" name="editcmt" class="view-all-accent-btn">Edit</button></a>
                                          
                                           
                                     <a href="companydetails_action.php?company_id='.$row["company_id"].'" onClick="return del()"><button type="submit" name="delecmt" class="view-all-accent-btn">Delete</button></a>
                                         </div>
