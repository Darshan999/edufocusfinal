        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $company_id=$_REQUEST["company_id"];
                 $obj=new database();
                 $res=$obj->companydisplaybyid($company_id);
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="lecturers-contact-info">
                                <img src="<?php echo $company_logo;?>" class="expertviewprofile img-responsive" alt="team" style="height: 360px; width:400px;">
                                <h2 style="height: 360px; width:45px;"><?php echo $company_name;?></h2>
                              
                               
                            </div>  
                        </div>  
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                            <h3 class="title-default-left title-bar-big-left-close">About Company</h3>
                            <p><?php echo $company_desc;?></p>
                           
                           
                        </div>      
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                            <h3 class="title-default-left title-bar-big-left-close">More Information</h3>
                             <p><a  href="<?php echo  $company_web_name; ?>"><?php echo $company_web_name;?></a></p>
                        </div>         
                    </div>
                </div>
            </div>
