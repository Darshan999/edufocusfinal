...
<html lang="en">
  ...
  function allLetter(course_name)
{
  var letters=/^[A-Za-z]+$/;
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Course</h1></center>
        ...
        //    require 'database.php';
              ...
              else if($_FILES["photo"]["name"]!="")
              {
                 $target_dir = "../img/course/";
                   ...
                   $target_file="img/course/". basename($_FILES["photo"]["name"]);
              }
            //require 'database.php';

            $obj1=new database();
            $res1=$obj1->insertcourse($course_name,$target_file);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                               <input class="form-control " id="coursename" name="course_name" type="text" placeholder="Enter Name " onblur="return allLetter(course_name);" required="" />
                                          </div>
                                          </div>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="courseadd">Add Course</button>
