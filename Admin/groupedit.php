...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Edit Group</h1></center>
    <div class="panel-body">
     ...
     ?>
       ...
       <!--  edit Students  -->
            ...
            $obj1=new database();
            $res1=$obj1->updategroup($grp_id,$grp_date,$fk_sub_id);
        ...
        <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                                  ...
                                  <center>
                             <button type="submit" name="grpedit" class="btn btn-success text-center">Submit</button>
                                  </center>
