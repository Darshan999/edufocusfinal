...
<html lang="en">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         ...
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="course.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $course_id)
         {
            $res=$obj->coursemuldel($course_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Courses Details</h1></center>
    <form method="post" action="">

    <div class="panel-body">
    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
    <a href="addcourse.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    <thead>
      ...
      <th><i class="fa fa-graduation-cap"></i> Name</th>
      ...
      <?php
          ...
          while($row=mysql_fetch_assoc($res))
          {
            $course_id=$row["course_id"];
              ...
              echo'<tr>';
            ?>
            <td><input type="checkbox" name="chk[]" value="<?php echo $row["course_id"]; ?>" /></td>

          <?php
              echo '<td>'.$row["course_name"].'</td>
              <td><img src="../'.$row["course_photo"].'" class="imgdisplay"/></td>
   
              <td><a href="courseedit.php?course_id='.$course_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="courseaction.php?course_id='.$course_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
