...
<html lang="en">
      ...
      <?php
       ...
       if(isset($_POST["delete"]))
       {
        ...
        else
        {
         ...
         foreach($idArr as $que_id)
         {
            $res=$obj->questionmuldel($que_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Questions Details</h1></center>
    <form action="" method="post">
    <div class="panel-body">

    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
    <a href="addquestion.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
         ...
         // include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            $que_id=$row["que_id"];
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["que_id"]; ?>" /></td>
              <?php 
              echo ' 
              <td><a href="answer.php?que_id='.$que_id.'">'.$row["que_title"].'</a></td>
              <td>'.$row["que_date"].'</td>
              <td>'.$row["u_name"].'</td>
              <td>'.$row["sub_name"].'</td>
              <td>
              <a href="questionedit.php?que_id='.$que_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="questionaction.php?que_id='.$que_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
