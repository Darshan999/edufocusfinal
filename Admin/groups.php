...
<html lang="en">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="groups.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $grp_id)
         {
            $res=$obj->groupmuldel($grp_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Groups Details</h1></center>
         ...
         // include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            $grp_id=$row["grp_id"];
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["grp_id"]; ?>" /></td>
              <?php 
              echo '  
              <td>'.$row["grp_date"].'</td>
              <td>'.$row["u_name"].'</td>
              <td>'.$row["sub_name"].'</td>
              <td>
              <a href="groupaction.php?grp_id='.$grp_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
