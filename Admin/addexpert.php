...
<!--validation -->
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Expert</h1></center>
   ...
   <?php
         ...
         //   require 'database.php';
            $obj1=new database();
            $res1=$obj1->insertexpert($u_email_id,$u_name,$u_password,$target_file,$u_mobile_no,$u_gender,$u_qualification,$u_desc,$u_active,$u_status,$u_type);
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="username" name="u_name" type="text" placeholder="Enter Name " onblur="return allLetter(u_name);" required="" /></div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="confirm_password"  type="password" onblur="return passid_validation(txtpass1);" name="txtpass1" placeholder="Re-Enter Password" required=""/>
                                          </div>
                                      </div>
                                       <div class="form-group ">
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group ">
                                          <label for="address" class="control-label col-lg-2">Qualification <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="address" name="u_qualification" type="text" required="" />
                                          </div>
                                      </div>

                                       <div class="form-group ">
                                          <label for="address" class="control-label col-lg-2">Description <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="u_desc" rows="6" placeholder=" Description" ></textarea>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="expertadd">Add Expert</button>
