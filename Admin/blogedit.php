...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Edit Blog</h1></center>
    <div class="panel-body">
     ...
     ?>
       ...
       <!--  edit Students  -->
            ...
            $obj1=new database();
            $res1=$obj1->updateblog($blog_id,$blog_title,$blog_desc,$blog_date,$blog_time,$photo,$fk_sub_id);
                          ...
                          <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                   <label>Description :</label>
                                      <textarea class="form-control ckeditor" name="blog_desc" rows="6" placeholder=" Description" ><?php echo $blog_desc; ?></textarea>
                                      <div class="help-block with-errors"></div>
                                  </div>


                                  <img height="100px" width="100px" src="<?php echo '../'.$blog_photo; ?>" ><?php echo $blog_photo; ?>
                                  ...
                                  <center>
                             <button type="submit" name="blogedit" class="btn btn-success text-center">Submit</button>
                                  </center>
