...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Edit Question</h1></center>
     ...
     ?>
       ...
       <!--  edit Students  -->
          <?php
            ...
            $obj1=new database();
            $res1=$obj1->updateque($que_id,$que_title,$que_date,$que_time,$fk_sub_id);
                          ...
                          <div class="panel-body">
                               <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="quetitle" rows="6" placeholder=" Description" ><?php echo $que_title; ?></textarea>
                                      ...
                                      ?>
                                       ...
                                       <center>
                             <button type="submit" name="queedit" class="btn btn-success text-center">Submit</button>
                                  </center>
