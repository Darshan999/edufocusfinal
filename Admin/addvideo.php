...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Video</h1></center>
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                       <label class="control-label col-lg-2">video <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input type="text" name="video" placeholder="Enter Only YouTube video path" class="form-control" required="">
                                              <div class="help-block with-errors"></div>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="videoadd">Add Video</button>
