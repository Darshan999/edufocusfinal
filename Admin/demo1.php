...
value="<?php echo $rows['u_name']; ?>"></td>
<td><?php echo $rows['u_mobile_no']; ?></td>
<td><?php echo $rows['u_gender']; ?></td>
<td><?php echo $rows['u_email_id']; ?></td>
</tr>
...
$sql = "DELETE FROM user_tbl WHERE u_email_id='$del_id'";
$result = mysql_query($sql);
}
