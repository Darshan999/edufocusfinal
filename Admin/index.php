...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      //require_once 'database.php';
        $obj1=new database();
            $res1=$obj1->getDashBoardBlogData();
            
            $results['week_number'] = array();
            $results['total_records'] = array();
            while($data=mysql_fetch_assoc($res1))
            {

            		$results['week_number'][] = $data['week_name'];
            		$results['total_records'][] = $data['total_records'];
                  ...
                  <section class="panel">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-6">
                              <section class="panel">
                                  <header class="panel-heading">
                                      Questions-Answers Added in a Months
                                      <?php 
                              
                                $obj=new database();
                                $res=$obj->getAllActiveQuestion();
