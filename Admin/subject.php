...
<html lang="en">
       ...
       if(isset($_POST["delete"]))
       {
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="subject.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $sub_id)
         {
            $res=$obj->subjectmuldel($sub_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Subjects Details</h1></center>
    <form action="" method="post">
    <div class="panel-body">

    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
    <a href="addsubject.php" class="btn btn-primary" ><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    <thead>
      ...
      <th><i class="fa fa-book fa-fw"></i> Name</th>
      <th><i class="fa fa-picture-o"></i> Photo</th>
      <th><i class="fa fa-user"></i> User Name</th>
      <th><i class="fa fa-graduation-cap"></i> Course Name</th>
         ...
         // include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            $sub_id=$row["sub_id"];
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["sub_id"]; ?>" /></td>
              <?php 
              echo '  

              <td>'.$row["sub_name"].'</td>
              <td><img src="../'.$row["sub_photo"].'" class="imgdisplay"/></td>
              <td>'.$row["u_name"].'</td>
              <td>'.$row["course_name"].'</td>
   
              <td><a href="subjectedit.php?sub_id='.$sub_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="subjectaction.php?sub_id='.$sub_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
