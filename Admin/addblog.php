...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Blog</h1></center>
                      ...
                      if($_FILES["photo"]["name"]=="")
                        {
                          ...
                          $target_file="";
                           ...
                           $target_file="img/blog/". basename($_FILES["photo"]["name"]);

                         }
          //  require 'database.php';
            $obj1=new database();
            $res1=$obj1->insertblog($blog_title,$blog_desc,$blog_date,$blog_time,$target_file,$flag,$view,$u_email_id,$fk_sub_id);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " name="blog_title" type="text" placeholder="Blog Title" required="" />
                                            </div>
                                      </div>
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="blog_desc" rows="6" placeholder=" Description" ></textarea>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="blogadd">Add Blog</button>
