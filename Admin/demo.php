...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="panel-body">
        ...
        <form action="studentmuldel.php"  id="form" method="post"> 
      ...
      <?php
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            if($row["u_type"]=="student" || $row["u_type"]=="admin")
            {
              ...
              echo "<tr>";
    echo '<td>'.'<input type="checkbox" name="chk[]" style="opacity:1" value='.$row["u_email_id"].'/>'.'</td>';
    echo "<td>".$row['u_email_id']."</td>";
