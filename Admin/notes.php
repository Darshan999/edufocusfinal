...
<html lang="en">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="notes.php";
                        </script>';
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Notes Details</h1></center>
     <form action="" method="post">
    <div class="panel-body">

    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
   <a href="addnotes.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $notes=$row["notes"];
             ...
             if($type=="pdf" || $type=="ppt" || $type=="PDF" || $type=="PPT")
              ...
              <td>
              <a href="notesaction.php?notes_id='.$notes_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
