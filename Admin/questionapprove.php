...
<html lang="en">
 ...
 <link href="pagination/demo/Content/bootstrap.min.css" rel="stylesheet">
       ...
       if(isset($_POST["delete"]))
       {
        ...
        @@$idArr = $_POST['chk'];
          if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="questionapprove.php";
                        </script>';
      ...
      <?php
       ...
       // include 'database.php'; 
        ...
        {               
         foreach($idArr as $que_id)
         {
            $res=$obj->questionmulapprove($que_id);
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text"> Approve Questions</h1></center>
      ...
      <?php
          ...
          while($row=mysql_fetch_assoc($res))
          {
             $que_id=$row["que_id"];
              ...
              <td>'.$row["u_name"].'</td>
              <td>'.$row["sub_name"].'</td>
              <td><a href="questionapprovecode.php?que_id='.$row["que_id"].'" class="btn btn-success"><span class="glyphicon glyphicon-ok" arial-hidden="true"></span></a>

             <a href="questiondisapprove.php?que_id='.$row["que_id"].'" onClick="return del()" class="btn btn-danger"><span class="glyphicon glyphicon-remove" arial-hidden="true"></span></a></td>
              </tr>';
