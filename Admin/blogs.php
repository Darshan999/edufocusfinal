...
<html lang="en">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="blogs.php";
                        </script>';
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Blogs Details</h1></center>
     <form action="" method="post">
    <div class="panel-body">

    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
   <a href="addblog.php" class="btn btn-primary" ><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
         ...
         // include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $sortcontent=substr($row["blog_desc"],0,40)."...";
              ...
              <td><a href="blogedit.php?blog_id='.$blog_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="blogaction.php?blog_id='.$blog_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
