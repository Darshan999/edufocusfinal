...
<script type="text/javascript">
      ...
      function allLetter(sub_name)
{
  var letters=/^[A-Za-z]+$/;
  if(sub_name.value.match(letters))
  {
      return true;
  }
  else
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Subject</h1></center>
   ...
   <?php
            ...
            if(isset($_POST["subjectadd"]))
            {
              ...
              $fk_u_email_id=$_POST["fk_u_email_id"];      
              ...
              $target_dir = "../img/Subject/";
              $target_file = $target_dir . basename($_FILES["txt_photo"]["name"]);
              move_uploaded_file($_FILES["txt_photo"]["tmp_name"], $target_file);
              $target_file="img/Subject/". basename($_FILES["txt_photo"]["name"]);
             
            }
           
          //  require 'database.php';
            $obj1=new database();
            $res1=$obj1->insertsubject($sub_name,$target_file,$fk_course_id,$fk_u_email_id);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="coursename" name="sub_name" type="text" placeholder="Enter Name "  required="" />
                                            </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group ">
                                          <label class="control-label col-lg-2">Course Name <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <select class="form-control m-bot15" name="fk_course_id">
                                                 <?php 
                                       ...
                                       <div class="form-group ">
                                          <label class="control-label col-lg-2">Expert Name <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <select class="form-control m-bot15" name="fk_u_email_id">
                                                 <?php 
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="subjectadd">Add Subject</button>
