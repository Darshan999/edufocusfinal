...
<html lang="en">
 ...
 <link href="pagination/demo/Content/bootstrap.min.css" rel="stylesheet">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="studentapprove.php";
                        </script>';
        ...
        else
        {
         ...
         {
            $res=$obj->studentmuldel($u_email_id);
      ...
      <?php
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                          echo '<script language="javascript">;
                        alert("Please Selece Check Box");window.location.href="studentapprove1.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $u_email_id)
         {
            $res=$obj->studentmulapprove($u_email_id);
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text"> Approve Students</h1></center>
         ...
         // include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            if($row["u_type"]=="student")
            {
              ...
              <td>'.$row["u_gender"].'</td>
              <td><a href="studentapprovecode.php?u_email_id='.$row["u_email_id"].'" class="btn btn-success"><span class="glyphicon glyphicon-ok" arial-hidden="true"></span></a>

             <a href="studentdisapprove.php?u_email_id='.$row["u_email_id"].'" onClick="return del()" class="btn btn-danger"><span class="glyphicon glyphicon-remove" arial-hidden="true"></span></button></a></td>
              </tr>';
        }
      }
      ?>
