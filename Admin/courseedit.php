...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Edit Course</h1></center>
    <div class="panel-body">
      ...
      <?php
        ...
        $obj=new database();
        $res=$obj->coursedisplay1($course_id);
     ...
     ?>
       ...
       <!--  edit Students  -->
            ...
            $obj1=new database();
            $res1=$obj1->updatecourse($course_id,$course_name);
        ...
        <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                                  ...
                                  <center>
                             <button type="submit" name="courseedit" class="btn btn-success text-center">Submit</button>
                                  </center>
