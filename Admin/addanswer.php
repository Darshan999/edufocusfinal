...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Answer</h1></center>
   ...
   <?php
           ...
           // require 'database.php';
            $obj1=new database();
            $res1=$obj1->insertanswer($ans_desc,$ans_date,$ans_time,$flag,$view,$fk_que_id,$u_email_id);


             echo '<script langauge="javascript">;
                                    alert("Added sucessfully");
                                    window.location.href="answer.php?que_id='.$fk_que_id.'";
                                    </script>';
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="ans_desc" rows="6" placeholder=" Description" ></textarea>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="answeradd">Add Answer</button>
