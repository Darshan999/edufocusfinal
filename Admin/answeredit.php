...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Edit Answer</h1></center>
    <div class="panel-body">
     ...
     ?>
       ...
       <?php
            ...
            $obj1=new database();
            $res1=$obj1->updateans($ans_id,$ans_desc,$ans_date,$ans_time);
                          ...
                          <div class="panel-body">
                               <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="ansdesc" rows="6" placeholder=" Description" ><?php echo $ans_desc; ?></textarea>
                                       ...
                                       <center>
                             <button type="submit" name="ansedit" class="btn btn-success text-center">Submit</button>
                                  </center>
