...
<html lang="en">
      ...
      <?php
       ...
       // include 'database.php'; 
        ...
        if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="expert.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $u_email_id)
         {
            $res=$obj->expertmuldel($u_email_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Expert Details</h1></center>
    ...
    <div class="panel-body">
      ...
      <a href="addexpert.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></button></a>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    <thead>
      ...
      <th><i class="fa fa-female"></i> Gender</th>
      <th><i class="fa fa-graduation-cap"></i> Qualification</th>
      ...
      <?php
        ...
        //  include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $sortcontent=substr($row["u_desc"],0,40)."...";

            if($row["u_type"]=="expert")
            {
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["u_email_id"]; ?>" /></td>
              <?php 
              echo '
              <td>'.$row["u_email_id"].'</td>
              <td>'.$row["u_name"].'</td>
   
              <td><img src="../'.$row["u_photo"].'" class="imgdisplay"/></td>
              <td>'.$row["u_mobile_no"].'</td>
              <td>'.$row["u_gender"].'</td>
              <td>'.$row["u_qualification"].'</td>
              <td>'.$sortcontent.'</td>
              <td><a href="expertedit.php?u_email_id='.$u_email_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="expertaction.php?u_email_id='.$u_email_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></button></td>
              </tr>';
        }
      }
      ?>
