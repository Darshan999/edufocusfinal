...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add Notes</h1></center>
    ...
    <?php
                    ...
                    move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file);
                     $target_file="img/notes/". basename($_FILES["photo"]["name"]);
                    }
                  // echo "The file ". basename( $_FILES["photo"]["name"]). " has been uploaded.";

                      $filename_from_url = parse_url($target_file);
                ...
                $obj=new database();
                $res=$obj->insertnotes($notes_title,$notes_img,$target_file,$type,$flag,$u_email_id,$fk_sub_id);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" name="notetitle" placeholder="Notes Title" class="form-control" required="">
                                      ...
                                      <div class="form-group ">
                                       <label class="control-label col-lg-2">Notes <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                             <input type="file" name="photo"  class="form-control " placeholder="Notes Path" required="">
                                               <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="noteadd">Add Notes</button>
