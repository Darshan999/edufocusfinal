...
<html lang="en">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="news.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $news_id)
         {
            $res=$obj->newsmuldel($news_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">News Details</h1></center>
    <form action="" method="post">
    <div class="panel-body">

    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
    <a href="addnews.php" class="btn btn-primary" ><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
    ...
    <tbody>
      <?php
         ...
         // include'database.php';        
          ...
          {
            $news_id=$row["news_id"];
            $sortcontent=substr($row["news_desc"],0,40)."...";
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["news_id"]; ?>" /></td>
              <?php 
              echo '  
  
              <td>'.$row["news_title"].'</td>
              <td><a href="#">'.$sortcontent.'</a></td>
              <td><img src="../'.$row["news_photo"].'" class="imgdisplay"/></td>
              <td>'.$row["news_date"].'</td>
              <td>'.$row["u_name"].'</td>
            
              <td><a href="newsedit.php?news_id='.$news_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="newsaction.php?news_id='.$news_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
