...
<html lang="en">
      ...
      //  include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="video.php";
                        </script>';
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Videos Details</h1></center>
         <form action="" method="post">
    <div class="panel-body">

    <button class="btn btn-danger" type="submit" name="delete" onClick="return del()"><span>Delete All</span></button>
    <a href="addvideo.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    <thead>
      ...
      <th><i class="fa fa-video-camera"></i> Type</th>
        ...
        //  include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $notes=$row["notes"];
              ...
              <td><a href="'.$videolink.'"><img src="'.$imagelink.'" class="imgdisplay"/></a></td>
              <td>'.$row["type"].'</td>
              <td>'.$row["u_name"].'</td>
              <td>'.$row["sub_name"].'</td>
   
              <td>
              <a href="videoaction.php?notes_id='.$notes_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
