...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Edit Student</h1></center>
...
//        require 'database.php';
        ...
        $obj=new database();
        $res=$obj->studentdisplay1($u_email_id);
     ...
     ?>
       ...
       <!--  edit Students  -->
            ...
            $obj1=new database();
            $res1=$obj1->updatestudent($u_email_id,$u_name,$photo,$u_mobile_no,$u_gender);
        ...
        <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                                  ...
                                  <center>
                             <button type="submit" name="studentedit" class="btn btn-success text-center">Submit</button>
                                  </center>
