...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Add News</h1></center>
              ...
              if($_FILES["photo"]["name"]=="")
               ...
               else if($_FILES["photo"]["name"]!="")
               {
                 $target_dir = "../img/news/";
                   ...
                   $target_file="img/news/". basename($_FILES["photo"]["name"]);

                }
           
          //  require 'database.php';
            $obj1=new database();
            $res1=$obj1->insertnews($news_title,$news_desc,$target_file,$news_date,$u_email_id);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " name="news_title" type="text" placeholder="News Title" required="" />
                                            </div>
                                      </div>
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="news_desc" rows="6" placeholder=" Description" ></textarea>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="newsadd">Add News</button>
