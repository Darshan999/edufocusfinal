...
<html lang="en">
       ...
       if(isset($_POST["delete"]))
       {
        ...
        @@$idArr = $_POST['chk'];
         ...
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="question.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $ans_id)
         {
            $res=$obj->answermuldel($ans_id);
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Answer Details</h1></center>
   ...
   <?php
    ...
    echo '<a href="addanswer.php?que_id='.$que_id.'" class="btn btn-primary"><span class="glyphicon glyphicon-plus" arial-hidden="true"></span></a>';
    ?>
  ...
  <div class="panel-body">
    <?php
          ...
          include_once 'database.php';  
          $obj=new database();
          $res=$obj->questiondisplay1($que_id);
      ...
      <?php
          ...
          while($row=mysql_fetch_assoc($res))
          {
            ...
            $ans_id=$row["ans_id"];
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["ans_id"]; ?>" /></td>
              <?php 
              echo '  
              <td>'.$row["ans_desc"].'</td>
              <td>'.$row["ans_date"].'</td>
              ...
              <td>
               <a href="answeredit.php?ans_id='.$ans_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
            
              <a href="answeraction.php?ans_id='.$ans_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
