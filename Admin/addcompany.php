...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Give the referance of the Company</h1></center>
                      ...
                      if($_FILES["photo"]["name"]=="")
                        {
                          ...
                          $target_file="";
                           ...
                           $target_file="img/company/". basename($_FILES["photo"]["name"]);

                         }
          //  require 'database.php';
            $obj1=new database();
            $res1=$obj1->insertcompany($company_name,$target_file,$company_title,$company_desc,$company_web_name,$u_email_id);
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-lg-2">Upload Logo <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="company_title" rows="6" placeholder=" Description" ></textarea>
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control ckeditor" name="company_desc" rows="6" placeholder=" Description" ></textarea>
                                              <div class="help-block with-errors"></div>
                                      ...
                                      <div class="form-group ">
                                          <label class="control-label col-lg-2">Website URL <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " name="company_web_name" type="text" placeholder="Company URL" required="" />
                                            </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                              ...
                                              <center><button class="btn btn-primary text-center" type="submit" name="companyadd">Add Company</button>
