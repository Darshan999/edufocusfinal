...
?>
 ...
 <input type="text" id="month" placeholder="Month" value=<?php echo $month; ?>>
 <input type="text" id="day" placeholder="Day" value=<?php echo $day; ?>>
 <input type="text" id="year" placeholder="Year" value=<?php echo $year ;?>>
 <input type="text" id="hour" placeholder="Hour" value=<?php echo $hours ;?>>
 <input type="text" id="min" placeholder="Min" value=<?php echo $minutes; ?>>
