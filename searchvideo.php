                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="search-input searchbar_inputtext">
                                    <form method="get">
                                        ...
                                        <select class="form-control m-bot15 dropdown search_dropdown22" onChange="window.location='searchvideobyuser.php?video_title='+this.value">
                                        <option>Choose Videos From Selected User</option>
                                  ...
                                  //       $sub_id=$_SESSION["sub_id"];
                                         ...
                                         $obj=new database();
                                         $res=$obj->searchusernotes($sub_id,$u_email_id);
                                         ...
                                         while($row=mysql_fetch_assoc($res))
                                         {
                                           if($row["type"]=="video")
                                           {
                                            ...
                                            echo '<option>'.$row["notes_title"].'</option>';
                                             }
                                         }   
                                        ?>
                                        </select>
         ...
         <!--  search mate--><?php
                  ...
                  $u_email_id=$_REQUEST["u_email_id"];
                    $_SESSION['email']=$u_email_id;
                                        $_SESSION["sub_id"]=$sub_id;
                     $obj=new database();
                     $res=$obj->searchbyuservideo($sub_id,$u_email_id);
                    ...
                    echo '</br>';
                     echo '
                            ...
                            <a href="video_details.php?notes_id='.$notes_id.'"><h2 class="title-default-left">'.$row["notes_title"].'</h2>
                            </a>
