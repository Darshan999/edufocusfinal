...
<head>
        ...
        <title>EduFocus | Add-Notes</title>
                    ...
                    if($cnt1==1)
                     {
                        ...
                        $res=new database();
                        $cnt=$res->insertnotes($notes_title,$notes_img,$target_file,$type,$flag,$u_email_id,$fk_sub_id);

                        header('location:notes.php?sub_id='.$fk_sub_id.'');
                ...
                <div class="container">
                  ...
                  <form action=""  enctype="multipart/form-data" method="post">
                           ...
                           <div class="leave-comments">
                                        <h3 class="sidebar-title">Add Notes</h3>
                                        <div class="row">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group margin-bottom-none">
                                                                <button type="submit" name="notepost" class="view-all-accent-btn">Post Note</button>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                </form>
