                        ...
                        data-r-large-dots="false">  
                            ...
                            <div class="courses-box1">
                                ...
                                <div class="courses-img-wrapper hvr-bounce-to-bottom">
                                    <img class="img-responsive homecourseslider" src="'.$row["course_photo"].'" alt="courses">
                        ...
                        <div class="single-item">
                            <div class="lecturers1-item-wrapper">
                                <div class="lecturers-img-wrapper">
                                    <a href="exp_profile.php?u_email_id='.$row["u_email_id"].'"><img class="img-responsive homeexpertslider" style="" src="'.$row["u_photo"].'" alt="team"></a>
                                </div>
                         ...
                         while ($row=mysql_fetch_array($res,MYSQL_ASSOC)) 
                         {
                                ...
                                <li>
                                    <div class="news-img-holder">
                                        <a href="#"><img src="'.$row["news_photo"].'" class="img-responsive homepage homenews" style=" alt="news"></a>
                                    </div>
