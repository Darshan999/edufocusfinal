                        ...
                        <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="search-input searchbar_inputtext">
                                  ...
                                  //       $sub_id=$_SESSION["sub_id"];
                                         ...
                                         $obj=new database();
                                         $res=$obj->searchuserblogs($sub_id,$u_email_id1);
                                         ...
                                         while($row=mysql_fetch_assoc($res))
                                         {
                                            ...
                                            $selected='';
                                         if(isset($_GET['blog_title']) && $_GET['blog_title'] == $row["blog_title"]) { 
                                                $selected='selected';
                                            }
                                         
                                            echo '<option '.$selected.' >'.$row["blog_title"].'</option>';
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                            ...
                            <?php //search mate
                             ...
                             $obj=new database();
                                ...
                                $res=$obj->searchblogsbyuser($blog_title,$sub_id,$u_email_id1);
